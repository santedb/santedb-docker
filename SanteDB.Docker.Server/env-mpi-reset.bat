...
SET SDB_FEATURE=LOG;DATA_POLICY;AUDIT_REPO;ADO;RAMCACHE;SEC;SWAGGER;OPENID;MDM;FHIR;FHIR_AUDIT;HL7;HDSI;AMI;BIS;MATCHING;PUBSUB_ADO;IHE_PDQM;IHE_PIXM;IHE_PMIR
